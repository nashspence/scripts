...
_MEDIA_ALIASES = {
    ...
    "dvd-9": "dvd9", "dvd+9": "dvd9", "dvd9": "dvd9",
    "dvd-10": "dvd10", "dvd10": "dvd10",
    "dvd-18": "dvd18", "dvd18": "dvd18",
    "bd25": "bdr25", "bdr25": "bdr25", "bd-r25": "bdr25", "bd-r": "bdr25",
    "bd50": "bdr50", "bdr50": "bdr50", "bd-r50": "bdr50",
    "bd100": "bdr100", "bdr100": "bdr100", "bdxl100": "bdr100",
    "bd128": "bdr128", "bdr128": "bdr128", "bdxl128": "bdr128",
}
...
def ffprobe_duration(path: str) -> float:
    data = ffprobe_json(
        ["ffprobe","-hide_banner","-v","error","-show_entries","format=duration","-of","json","-i",path]
    )
